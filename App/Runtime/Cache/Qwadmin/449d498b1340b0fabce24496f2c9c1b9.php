				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									<form class="form-horizontal" id="form" method="post" action="<?php echo U('matchingxiugai');?>?id=<?php echo ($id); ?>">
									
									
									<div class="space-4"></div>
									
					   <input style="display:none;" type="text" value="<?php echo ($matching['id']); ?>" name="id">
                      ...
                      <div class="form-group" id="felgcnhzdiv">
                         ...
                         <select name="cn_mgname" id="felgcnhz" class="col-xs-10 col-sm-5">
                                 ...
                                 <?php if(is_array($felgproduct)): $i = 0; $__LIST__ = $felgproduct;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option <?php if($matching['cn_mgname'] == $val['cn_ftname']): ?>selected="selected" <?php else: endif; ?> value ="<?php echo ($val['cn_ftname']); ?>"> <?php echo ($val['cn_ftname']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                         </select>                  
                      ...
                      <div class="form-group" id="felgcntypediv">
                         ...
                         <select name="en_mgname" id="felgcntype" class="col-xs-10 col-sm-5">
                                 <option value ="0">请选择</option>
                                 <?php if(is_array($felgproduct)): $i = 0; $__LIST__ = $felgproduct;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option <?php if($matching['en_mgname'] == $val['en_ftname']): ?>selected="selected" <?php else: endif; ?> value ="<?php echo ($val['en_ftname']); ?>"> 
								   <?php echo ($val['en_ftname']); ?>
                      ...
                      <div class="form-group">
                         ...
                         <div class="col-sm-9">
                           <input type="number" name="mgsort" id="o" placeholder="排序" class="col-xs-10 col-sm-5" value="<?php echo ($matching['mgsort']); ?>">
                           <span class="help-inline col-xs-12 col-sm-7">
