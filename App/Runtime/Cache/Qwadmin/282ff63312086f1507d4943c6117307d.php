				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo U('Felgproduct/index');?>">FEIG系列产品</a>
							</li>
							<li>
								FEIG产品匹配
							</li>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<div class="cf">
									<a class="btn btn-info" href="<?php echo U('matchingadd');?>?id=<?php echo ($ids); ?>" value="">新增产品匹配</a>
								...
								<form id="form" method="post" action="<?php echo U('del');?>">
									...
									<thead>
										<tr>
											...
											<th class="col-xs-2 center">中文匹配FELG产品</th>
											<th class="col-xs-2 center">英文匹配FELG产品</th>
									...
									<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
											...
											<td class="center"><?php echo ($val['cn_mgname']); ?></td>
											<td class="center"><?php echo ($val['en_mgname']); ?></td>
											<td class="center"><?php echo ($val['mgsort']); ?></td>
											<td class="center">
											<a href="<?php echo U('matchingedit');?>?id=<?php echo ($val['id']); ?>"><i class="ace-icon fa fa-pencil bigger-100"></i>修改</a>
											
											&nbsp&nbsp;
											<a href="javascript:;" val="<?php echo U('matchingdel');?>?ids=<?php echo ($val['id']); ?>" class="dellink">
