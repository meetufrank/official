								...
								<form id="form" method="post" action="<?php echo U('del');?>">
									...
									<thead>
										<tr>
											...
											<th class="col-xs-2 center">中文RFIG是否开启</th>
											<th class="col-xs-2 center">英文RFIG是否开启</th>
											<th class="col-xs-2 center">中文RFLINKER是否开启</th>
											<th class="col-xs-2 center">英文RFLINKER是否开启</th>
											<th class="col-xs-2 center">中文推荐是否开启</th>
											<th class="col-xs-2 center">英文推荐是否开启</th>
											<th>操作</th>
										</tr>
									</thead>
									<tbody>
									<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
											...
											<td class="center"><?php if($val['cn_fghzshow'] == 1): ?>开启<?php elseif($val['cn_fghzshow'] == 2): ?>不开启<?php endif; ?></td>
											<td class="center"><?php if($val['en_fghzshow'] == 1): ?>开启<?php elseif($val['en_fghzshow'] == 2): ?>不开启<?php endif; ?></td>
											<td class="center"><?php if($val['cn_rrhzshow'] == 1): ?>开启<?php elseif($val['cn_rrhzshow'] == 2): ?>不开启<?php endif; ?></td>
											<td class="center"><?php if($val['en_rrhzshow'] == 1): ?>开启<?php elseif($val['en_rrhzshow'] == 2): ?>不开启<?php endif; ?></td>
											<td class="center"><?php if($val['cn_tjhzshow'] == 1): ?>开启<?php elseif($val['cn_tjhzshow'] == 2): ?>不开启<?php endif; ?></td>
											<td class="center"><?php if($val['en_tjhzshow'] == 1): ?>开启<?php elseif($val['en_tjhzshow'] == 2): ?>不开启<?php endif; ?></td>
											
											<td><a href="<?php echo U('edit');?>?id=<?php echo ($val['id']); ?>"><i class="ace-icon fa fa-pencil bigger-100"></i>修改</a>&nbsp&nbsp;
											</td>
