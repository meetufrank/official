					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<div class="cf">
									<a class="btn btn-info" href="<?php echo U('add');?>" value="">新增下载用户</a>
								</div>
								...
								<form id="form" method="post" action="<?php echo U('del');?>">
									...
									<thead>
										<tr>
											...
											<th class="col-xs-2 center">用户名称</th>
											<th class="col-xs-2 center">用户密码</th>
									...
									<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
											...
											<td class="center"><?php echo ($val['dowusername']); ?></td>
											<td class="center"><?php echo ($val['dowuserpwd']); ?></td>
											...
											<td class="center">
												...
												<a href="<?php echo U('userdown');?>?id=<?php echo ($val['id']); ?>"><i class="ace-icon fa fa-arrow-down bigger-100"></i>下载</a>&nbsp&nbsp;
												<a href="javascript:;" val="<?php echo U('del');?>?ids=<?php echo ($val['id']); ?>" class="dellink"><i class="ace-icon fa fa-trash-o bigger-100 red"></i>删除</a>
											</td>
