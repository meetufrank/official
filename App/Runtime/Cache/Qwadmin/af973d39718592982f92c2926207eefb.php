								...
								<form id="form" method="post" action="<?php echo U('del');?>">
									...
									<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td class="center">
											 ...
											 <td class="center">
											   <?php if($val['cn_fwshowpc'] == 2): ?>暂不开启<?php endif; ?>
											   <?php if($val['cn_fwshowpc'] == 1 and $val['cn_flashviewphone'] != ''): ?><img src="<?php echo ($val['cn_flashviewphone']); ?>" style="width:100px; height:50px;"><?php endif; ?>
											 ...
											 <td class="center">
											   <?php if($val['en_fwshowpc'] == 2): ?>暂不开启<?php endif; ?>
											   <?php if($val['en_fwshowpc'] == 1 and $val['en_flashviewphone'] != ''): ?><img src="<?php echo ($val['en_flashviewphone']); ?>" style="width:100px; height:50px;"><?php endif; ?>
