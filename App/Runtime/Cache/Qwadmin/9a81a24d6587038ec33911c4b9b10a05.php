				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo U('Industry/index');?>">支持</a>
							</li>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<div class="cf">
									<a class="btn btn-info" href="<?php echo U('add');?>" value="">新增支持下载</a>
									<span>支持下载验证码:</span>
									<span><?php echo ($codeyzm); ?></span>
								</div>
								...
								<form id="form" method="post" action="<?php echo U('del');?>">
									...
									<thead>
										<tr>
											...
											<th class="col-xs-2 center">中文名称</th>
											<th class="col-xs-2 center">英文名称</th>
											<th class="col-xs-2 center">中文类型</th>
											<th class="col-xs-2 center">英文类型</th>
									...
									<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
											...
											<td class="center"><?php echo ($val['cn_stname']); ?></td>
											<td class="center"><?php echo ($val['en_stname']); ?></td>
											<td class="center"><?php if($val['cn_sttype'] == 1 ): ?>CDK<?php elseif($val['cn_sttype'] == 2): ?>DEMO<?php elseif($val['cn_sttype'] == 3): ?>公共<?php endif; ?></td>
											<td class="center"><?php if($val['en_sttype'] == 1 ): ?>CDK<?php elseif($val['en_sttype'] == 2): ?>DEMO<?php elseif($val['en_sttype'] == 3): ?>公共<?php endif; ?></td>
											<td class="center"><?php echo ($val['stsort']); ?></td>
