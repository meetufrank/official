							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="form-group" id="felgcntypediv">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> FELG中文类型 </label>
										<div class="col-sm-9">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="cn_ftname" id="url" placeholder="中文产品名称" class="col-xs-10 col-sm-5" value="<?php echo ($link['cn_ftname']); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea style="width:400px; height:100px;" name="cn_fttitle" rows="3" cols="8"><?php echo ($link['cn_fttitle']); ?></textarea>
											<span class="help-inline col-xs-12 col-sm-7">
								    ...
								    <div class="form-group">
										...
										<div class="col-sm-9">
											<textarea name="cn_ftspec" id="cn_ftspec" style="width:100%;height:400px;visibility:hidden;"><?php echo ($link['cn_ftspec']); ?></textarea>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="col-xs-10 col-sm-5"><?php echo UpImage("cn_ftimg",88,31,$link['cn_ftimg']);?></div>
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group" style="display:none;">
										...
										<div class="col-sm-9">
											<input type="radio" name="cn_choose" id=""  <?php if($link['cn_choose'] == 1): ?>checked="checked" <?php else: endif; ?> value="1">推荐&nbsp;&nbsp;&nbsp;
											<input type="radio" name="cn_choose" id=""  <?php if($link['cn_choose'] == 1): ?>checked="checked" <?php else: endif; ?> value="2">不推荐
										</div>
									</div>
									...
									<div class="form-group" style="display:none;">
										...
										<div class="col-sm-9">
											<input type="number" name="cn_choosesort" id="o" placeholder="排序" class="col-xs-10 col-sm-5" value="<?php echo ($link['cn_choose']); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="en_ftname" id="url" placeholder="中文产品名称" class="col-xs-10 col-sm-5" value="<?php echo ($link['en_ftname']); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea style="width:400px; height:100px;" name="en_fttitle" rows="3" cols="8"><?php echo ($link['en_fttitle']); ?></textarea>
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea name="en_ftspec" id="en_ftspec" style="width:100%;height:400px;visibility:hidden;"><?php echo ($link['en_ftspec']); ?></textarea>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="col-xs-10 col-sm-5"><?php echo UpImage("en_ftimg",88,31,$link['en_ftimg']);?></div>
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">仅支持jpg、gif、png、bmp、jpeg，且小于1MB。</span>
											</span>
										</div>
									...
									<div class="form-group" style="display:none;">
										...
										<div class="col-sm-9">
											<input type="radio" name="en_choose" id="" <?php if($link['en_choose'] == 1): ?>checked="checked" <?php else: endif; ?> value="1">推荐&nbsp;&nbsp;&nbsp;
											<input type="radio" name="en_choose" id="" <?php if($link['en_choose'] == 2): ?>checked="checked" <?php else: endif; ?> value="2">不推荐
										</div>
									</div>
							        ...
							        <div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 产品是否推荐搜索 </label>
										<div class="col-sm-9">
									...
									<div class="form-group" style="display:none;">
										...
										<div class="col-sm-9">
											<input type="number" name="en_choosesort" id="o" placeholder="排序" class="col-xs-10 col-sm-5" value="<?php echo ($link['en_choosesort']); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">越小越靠前。</span>
											</span>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" name="ftsort" id="o" placeholder="排序" class="col-xs-10 col-sm-5" value="<?php echo ($link['ftsort']); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">越小越靠前。</span>
											</span>
										</div>
...
<script src="/Public/ckeditorbiaozhun/ckeditor.js"></script>
				<!-- basic scripts -->
