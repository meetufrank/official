							...
							<div class="col-xs-12">	
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="col-xs-10 col-sm-5"><?php echo UpImage("cn_flashviewpc",88,31,$link['cn_flashviewpc']);?><span>1920*1080</span></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="radio" name="cn_fwshowpc" <?php if($link['cn_fwshowpc'] == 1): ?>checked="checked" <?php else: endif; ?>  value="1">开启&nbsp;&nbsp;
											<input type="radio" name="cn_fwshowpc" <?php if($link['cn_fwshowpc'] == 2): ?>checked="checked" <?php else: endif; ?>  value="2">不开启
											<span>
									...
									<div style="display:none;" class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-4">中文轮播图</label>
										<div class="col-sm-9">
											<div class="col-xs-10 col-sm-5"><?php echo UpImage("cn_flashviewphone",88,31,$link['cn_flashviewphone']);?></div>
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">仅支持jpg、png，且小于1MB。</span>
											</span>
										</div>
									...
									<div style="display:none;"  class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-2"> 中文轮播图是否开启 </label>
										<div class="col-sm-9">
											<input type="radio" name="cn_fwshowphone"  <?php if($link['cn_fwshowphone'] == 1): ?>checked="checked" <?php else: endif; ?> value="1">开启&nbsp;&nbsp;
											<input type="radio" name="cn_fwshowphone"  <?php if($link['cn_fwshowphone'] == 2): ?>checked="checked" <?php else: endif; ?> value="2">不开启
											<span>
												<span class="middle"></span>
											</span>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										<textarea placeholder="标题不能超过十二个字符" name="cn_title" style="width:400px; height:100px;" rows="3" cols="18"><?php echo ($link['cn_title']); ?></textarea>
											<span class="help-inline col-xs-12 col-sm-7">	
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="url" name="cn_fwlink" id="url" placeholder="中文链接" class="col-xs-10 col-sm-5" value="<?php echo ($link['cn_fwlink']); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="col-xs-10 col-sm-5"><?php echo UpImage("en_flashviewpc",88,31,$link['en_flashviewpc']);?><span>1920*1080</span></div>
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">仅支持jpg、png，且小于1MB。</span>
											</span>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="radio" name="en_fwshowpc"  <?php if($link['en_fwshowpc'] == 1): ?>checked="checked" <?php else: endif; ?>  value="1">开启&nbsp;&nbsp;
											<input type="radio" name="en_fwshowpc"  <?php if($link['en_fwshowpc'] == 2): ?>checked="checked" <?php else: endif; ?>  value="2">不开启
											<span>
												<span class="middle"></span>
											</span>
										</div>
									...
									<div style="display:none;"  class="form-group">
										...
										<div class="col-sm-9">
											<div class="col-xs-10 col-sm-5"><?php echo UpImage("en_flashviewphone",88,31,$link['en_flashviewphone']);?></div>
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">仅支持jpg、png，且小于1MB。</span>
											</span>
										</div>
									...
									<div style="display:none;"  class="form-group">
										...
										<div class="col-sm-9">
											<input type="radio" name="en_fwshowphone"  <?php if($link['en_fwshowphone'] == 1): ?>checked="checked" <?php else: endif; ?>  value="1">开启&nbsp;&nbsp;
											<input type="radio" name="en_fwshowphone"  <?php if($link['en_fwshowphone'] == 2): ?>checked="checked" <?php else: endif; ?>value="2">不开启
											<span>
												<span class="middle"></span>
											</span>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										<textarea placeholder="标题不能超过十二个字符" name="en_title" style="width:400px; height:100px;" rows="3" cols="18"><?php echo ($link['en_title']); ?></textarea>
											<span class="help-inline col-xs-12 col-sm-7">	
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="url" name="en_fwlink" id="url" placeholder="英文链接" class="col-xs-10 col-sm-5" value="<?php echo ($link['en_fwlink']); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">链接要有http://</span>
											</span>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" name="fwsort" id="o" placeholder="排序" class="col-xs-10 col-sm-5" value="<?php echo ($link['fwsort']); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
