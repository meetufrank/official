...
<![endif]-->
		...
		<script src="/guanwang/qwadmin/Public/qwadmin/js/date-time/bootstrap-datepicker.js"></script>
		<script src="/guanwang/qwadmin/Public/qwadmin/js/function.js"></script>
		<script type="text/javascript">
		jQuery(function($){
			$('#birthday').datepicker({
				  format: 'yyyy-mm-dd',
