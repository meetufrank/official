				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									<form class="form-horizontal" id="form" method="post" action="<?php echo U('userdownedits');?>?id=<?php echo ($id); ?>" enctype="multipart/form-data">
									<!-- 产品id -->
                                   ...
                                   <div class="space-4"></div>
									 <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="file" name="photo[]"  placeholder="中文上传文件" class="col-xs-10 col-sm-5" value="<?php echo ($fgdown["en_down"]); ?>">
										    <?php if($fgdown["cn_down"] != '' ): ?>已上传中文文件名称&nbsp;&nbsp;<input type="text" value="<?php echo ($fgdown["cn_down"]); ?>" readonly="true"/>
											<?php else: ?>
											   中文文件暂未上传<?php endif; ?>
								   ...
								   <div class="space-4"></div>
									 <div class="form-group">
										...
										<div class="col-sm-9">
											...
											<?php if($fgdown["en_down"] != '' ): ?>已上传英文文件名称&nbsp;&nbsp;<input type="text" value="<?php echo ($fgdown["en_down"]); ?>" readonly="true"/>
											<?php else: ?>
											   英文文件暂未上传<?php endif; ?>
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle"></span>
								  ...
								  <div class="form-group">
									 ...
									 <div class="col-sm-9">
									   <input type="number" name="downsort" id="o" placeholder="排序" class="col-xs-10 col-sm-5" value="<?php echo ($fgdown["o"]); ?>">
									   <span class="help-inline col-xs-12 col-sm-7">
...
<![endif]-->
		...
		<script src="/zhanggw/Public/ckeditorbiaozhun/ckeditor.js"></script>
		<script type="text/javascript">
		      $(function(){
			       //点击felg中文频率事件
