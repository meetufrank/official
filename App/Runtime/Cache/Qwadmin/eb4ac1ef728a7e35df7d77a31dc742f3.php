								...
								<div class="space-4"></div>
									<form id="form" method="post" action="<?php echo U('del');?>">
										...
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
												...
												<td class="center"><?php if($val["islink"] == 1): ?>显示<?php else: ?>隐藏<?php endif; ?></td>
												<td><?php echo ($val['o']); ?></td>
												<td class="center"><a href="<?php echo U('edit');?>?id=<?php echo ($val['id']); ?>">修改</a>&nbsp;<a class="del" href="javascript:;" val="<?php echo U('del');?>?ids=<?php echo ($val['id']); ?>" title="删除">删除</a></td>
											</tr>
											<?php if(!empty($val["children"])): if(is_array($val["children"])): $i = 0; $__LIST__ = $val["children"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
													...
													<td class="center"><?php if($v["islink"] == 1): ?>显示<?php else: ?>隐藏<?php endif; ?></td>
													<td><?php echo ($v['o']); ?></td>
													<td class="center"><a href="<?php echo U('edit');?>?id=<?php echo ($v['id']); ?>">修改</a>&nbsp;<a class="del" href="javascript:;" val="<?php echo U('del');?>?ids=<?php echo ($v['id']); ?>" title="删除">删除</a></td>
												</tr>
												<?php if(!empty($v["children"])): if(is_array($v["children"])): $i = 0; $__LIST__ = $v["children"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><tr>
														<td class="center">
															<input class="ids" type="checkbox" name="ids[]" value="<?php echo ($vv['id']); ?>">
														</td>
														<td>&nbsp;&nbsp;&nbsp;&nbsp;┗━<?php echo ($vv['title']); ?></td>
														<td><?php echo ($vv['name']); ?></td>
														<td><i class="<?php echo ($vv["icon"]); ?>"></i></td>
														<td class="center"><?php if($vv["islink"] == 1): ?>显示<?php else: ?>隐藏<?php endif; ?></td>
														<td><?php echo ($vv['o']); ?></td>
														<td class="center"><a href="<?php echo U('edit');?>?id=<?php echo ($vv['id']); ?>">修改</a>&nbsp;<a class="del" href="javascript:;" val="<?php echo U('del');?>?ids=<?php echo ($vv['id']); ?>" title="删除">删除</a></td>
