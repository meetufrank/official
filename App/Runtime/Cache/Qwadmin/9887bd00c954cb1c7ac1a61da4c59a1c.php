					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<a class="btn btn-info" href="<?php echo U('add');?>" value="">新增行业类别</a>
								...
								<form id="form" method="post" action="<?php echo U('del');?>">
									...
									<thead>
										<tr>
											...
											<th class="col-xs-2 center">中文行业名称</th>
											<th class="col-xs-2 center">英文行业名称</th>
                                            <th class="col-xs-2 center">中文行业图片</th>
											<th class="col-xs-2 center">英文行业图片</th>
									...
									<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
											...
											<td class="center">
											     <?php echo ($val['cn_nameiy']); ?>
											</td>
											<td class="center">
											     <?php echo ($val['en_nameiy']); ?>
											</td>
                                            <td class="center">	 
                                              <?php if($val['cn_iyshowimg'] == 2): ?>暂不开启<?php endif; ?>
											  <?php if($val['cn_iyshowimg'] == 1 and $val['cn_imgiy'] != ''): ?><img src="/zhanggw<?php echo ($val['cn_imgiy']); ?>" style="width:100px; height:50px;"><?php endif; ?>
											  <?php if($val['cn_imgiy'] == ''): ?>暂无图片<?php endif; ?>											
											 </td>
								             <td class="center">	  
											  <?php if($val['en_iyshowimg'] == 2): ?>暂不开启<?php endif; ?>
											  <?php if($val['en_iyshowimg'] == 1 and $val['cn_imgiy'] != ''): ?><img src="/zhanggw<?php echo ($val['en_imgiy']); ?>" style="width:100px; height:50px;"><?php endif; ?>
											  <?php if($val['en_imgiy'] == ''): ?>暂无图片<?php endif; ?>		
											  </td>
											<td class="center"><?php echo ($val['iysort']); ?></td>
											<td>
											   <a href="<?php echo U('industryimgs');?>?id=<?php echo ($val['id']); ?>"><i class="ace-icon fa fa-photo bigger-100"></i>轮播图列表</a>&nbsp&nbsp;
											   <a href="<?php echo U('edit');?>?id=<?php echo ($val['id']); ?>"><i class="ace-icon fa fa-pencil bigger-100"></i>修改</a>&nbsp&nbsp;
