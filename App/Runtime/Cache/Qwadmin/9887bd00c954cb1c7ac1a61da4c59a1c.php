								...
								<form id="form" method="post" action="<?php echo U('del');?>">
									...
									<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td class="center">	 
											  ...
											  <?php if($val['cn_iyshowimg'] == 1 and $val['cn_imgiy'] != ''): ?><img src="<?php echo ($val['cn_imgiy']); ?>" style="width:100px; height:50px;"><?php endif; ?>
											  <?php if($val['cn_imgiy'] == ''): ?>暂无图片<?php endif; ?>											
											 </td>
								             <td class="center">	  
											  <?php if($val['en_iyshowimg'] == 2): ?>暂不开启<?php endif; ?>
											  <?php if($val['en_iyshowimg'] == 1 and $val['cn_imgiy'] != ''): ?><img src="<?php echo ($val['en_imgiy']); ?>" style="width:100px; height:50px;"><?php endif; ?>
