				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">FELG产品密码下载新增</li>
						</ul><!-- /.breadcrumb -->
					</div>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									<form class="form-horizontal" id="form" method="post" action="<?php echo U('felgptmmdnwrite');?>?id=<?php echo ($id); ?>" enctype="multipart/form-data">
									<!-- 产品id -->
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="cn_mmdownname" id="title" placeholder="中文下载名称" class="col-xs-10 col-sm-5" value="">
							       ...
							       <div class="space-4"></div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="en_mmdownname" id="title" placeholder="英文下载名称" class="col-xs-10 col-sm-5" value="">
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle"></span>
											</span>
										</div>
								  ...
								  <div class="form-group">
									 ...
									 <div class="col-sm-9">
									   <input type="number" name="mmdownsort" id="o" placeholder="排序" class="col-xs-10 col-sm-5" value="">
									   <span class="help-inline col-xs-12 col-sm-7">
