							...
							<div class="col-xs-12">	
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="col-xs-10 col-sm-5"><?php echo UpImage("cn_flashviewpc",88,31,$link['cn_flashviewpc']);?></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="col-xs-10 col-sm-5"><?php echo UpImage("en_flashviewpc",88,31,$link['en_flashviewpc']);?></div>
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">仅支持jpg、png，且小于1MB。</span>
											</span>
										</div>
