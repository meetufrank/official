				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									<form class="form-horizontal" id="form" method="post" action="<?php echo U('iyupdate');?>">
									...
									<div class="form-group">
									     <input style="display:none;"  type="text" name="id" value="<?php echo ($link["id"]); ?>" />
										 <input style="display:none;" type="text" name="iyid" value="<?php echo ($linkfu["id"]); ?>" />
										<label class="col-sm-1 control-label no-padding-right" for="form-field-2"> 中文行业名称 </label>
										
										<div class="col-sm-9">
										    <input disabled="disabled" type="text" class="col-xs-10 col-sm-2" value="<?php echo ($linkfu["cn_nameiy"]); ?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										    <input disabled="disabled" type="text" class="col-xs-10 col-sm-2" value="<?php echo ($linkfu["en_nameiy"]); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
											</span>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="col-xs-10 col-sm-5"><?php echo UpImage("cn_iyimgs",88,31,$link['cn_iyimgs']);?></div>
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="col-xs-10 col-sm-5"><?php echo UpImage("en_iyimgs",88,31,$link['en_iyimgs']);?></div>
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">仅支持jpg、png，且小于1MB。</span>
											</span>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" name="iyimgssort" id="o" placeholder="排序" class="col-xs-10 col-sm-5" value="<?php echo ($link["iyimgssort"]); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
