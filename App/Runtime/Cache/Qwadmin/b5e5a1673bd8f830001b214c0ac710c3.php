							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="cn_rflinkerhz" id="title" placeholder="中文RFLINKER频率" class="col-xs-10 col-sm-5" value="<?php echo ($link["cn_rflinkerhz"]); ?>">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea name="cn_rrtitle" rows="3" cols="46"><?php echo ($link["cn_rrtitle"]); ?></textarea>
								   ...
								   <div class="space-4"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="en_rflinkerhz" id="title" placeholder="英文RFLINKER频率" class="col-xs-10 col-sm-5" value="<?php echo ($link["en_rflinkerhz"]); ?>">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea name="en_rrtitle" rows="3" cols="46"><?php echo ($link["en_rrtitle"]); ?></textarea>
