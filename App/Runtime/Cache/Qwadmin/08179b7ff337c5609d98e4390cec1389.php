							...
							<div class="col-xs-12">
								...
								<form class="form-inline" action="<?php echo U('index');?>" method="get">
                                    ...
                                    <button type="submit" class="btn btn-purple btn-sm">
											...
											&nbsp;&nbsp;&nbsp;<a class="btn btn-info" href="<?php echo U('add');?>" value="">新增FELG产品</a>
									</div>
								...
								<form id="form" method="post" action="<?php echo U('del');?>">
									...
									<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
											...
											<td class="center"><?php echo ($val['cn_ftname']); ?></td>
											<td class="center"><?php echo ($val['en_ftname']); ?></td>
											<td class="center"><?php if($val['felgcnhzname'] != '0'): echo ($val['felgcnhzname']); ?> <?php else: ?>暂无中文频率<?php endif; ?></td>
											<td class="center"><?php if($val['felgenhzname'] != '0'): echo ($val['felgenhzname']); ?> <?php else: ?>暂无英文频率<?php endif; ?></td>
											<td class="center"><?php if($val['felgcntypename'] != '0'): echo ($val['felgcntypename']); ?> <?php else: ?>暂无中文类型<?php endif; ?></td>
											<td class="center"><?php if($val['felgentypename'] != '0'): echo ($val['felgentypename']); ?> <?php else: ?>暂无英文类型<?php endif; ?></td>
											<td class="center"><?php echo ($val['ftsort']); ?></td>
											<td class="center">
											<a href="<?php echo U('edit');?>?id=<?php echo ($val['id']); ?>"><i class="ace-icon fa fa-pencil bigger-100"></i>修改</a>
											<a href="<?php echo U('matching');?>?id=<?php echo ($val['id']); ?>"><i class="ace-icon fa fa-arrows-h bigger-100"></i>匹配</a>
											<a href="<?php echo U('felgDown');?>?id=<?php echo ($val['id']); ?>"><i class="ace-icon fa fa-arrow-down bigger-100"></i>下载</a>
											<!-- <a href="<?php echo U('felgMmDown');?>?id=<?php echo ($val['id']); ?>"><i class="ace-icon fa fa-download bigger-100"></i>密码下载</a> -->
											&nbsp&nbsp;
											<a href="javascript:;" val="<?php echo U('del');?>?ids=<?php echo ($val['id']); ?>" class="dellink">
											<i class="ace-icon fa fa-trash-o bigger-100 red"></i>删除</a></td>
