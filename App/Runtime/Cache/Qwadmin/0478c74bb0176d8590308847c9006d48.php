							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="en_fgtypename" id="title" placeholder="FELG类型英文" class="col-xs-10 col-sm-5" value="">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" name="fgtypesort" id="o" placeholder="排序" class="col-xs-10 col-sm-5" value="">
