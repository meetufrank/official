				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">修改RFLINKER密码下载文件</li>
						</ul><!-- /.breadcrumb -->
					</div>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									<form class="form-horizontal" id="form" method="post" action="<?php echo U('rrmmdownxiugai');?>?id=<?php echo ($id); ?>" enctype="multipart/form-data">
									<!-- 产品id -->
									<input type="text" style="display:none;" value="<?php echo ($fgdown["id"]); ?>" name="id">
									<input type="text" style="display:none;" value="<?php echo ($fgdown["rrptid"]); ?>" name="rrfuid">
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 中文下载名称 </label>
										<div class="col-sm-9">
											<input type="text" name="cn_downname" id="title" placeholder="中文下载名称" class="col-xs-10 col-sm-5" value="<?php echo ($fgdown["cn_rrmmdownname"]); ?>">
									 ...
									 <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="file" name="photo[]"  placeholder="中文上传文件" class="col-xs-10 col-sm-5" value="">
										     <?php if($fgdown["cn_mmdownname"] != '' ): ?>已上传中文文件名称&nbsp;&nbsp;<input type="text" value="<?php echo ($fgdown["cn_mmdownname"]); ?>" readonly="true"/>
											<?php else: ?>
											   中文文件暂未上传<?php endif; ?>
							       ...
							       <div class="space-4"></div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="en_downname" id="title" placeholder="英文下载名称" class="col-xs-10 col-sm-5" value="<?php echo ($fgdown["en_rrmmdownname"]); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle"></span>
											</span>
										</div>
								   ...
								   <div class="space-4"></div>
									 <div class="form-group">
										...
										<div class="col-sm-9">
										    ...
										    <?php if($fgdown["en_mmdownname"] != '' ): ?>已上传英文文件名称&nbsp;&nbsp;<input type="text" value="<?php echo ($fgdown["en_mmdownname"]); ?>" readonly="true"/>
											<?php else: ?>
											   英文文件暂未上传<?php endif; ?>
