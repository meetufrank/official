				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									<form class="form-horizontal" id="form" method="post" action="<?php echo U('dnwrite');?>?id=<?php echo ($id); ?>" enctype="multipart/form-data">
									<!-- 产品id -->
									<input style="display:none;" type="text" value="<?php echo ($id); ?>" name="dwuserid">
