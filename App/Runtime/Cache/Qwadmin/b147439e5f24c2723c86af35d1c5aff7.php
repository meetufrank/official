							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="cn_ftname" id="url" placeholder="中文产品名称" class="col-xs-10 col-sm-5" value="">
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										<textarea name="cn_fttitle" style="width:400px; height:100px;" rows="3" cols="18"></textarea>
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea name="cn_ftspec" id="en_ftspec" style="width:100%;height:400px;visibility:hidden;"></textarea>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="col-xs-10 col-sm-5"><?php echo UpImage("cn_ftimg",88,31);?></div>
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group" style="display:none;">
										...
										<div class="col-sm-9">
											<input type="radio" name="cn_choose" id=""  value="1">推荐&nbsp;&nbsp;&nbsp;
											<input type="radio" name="cn_choose" id=""  value="2">不推荐
										</div>
									</div>
									...
									<div class="form-group" style="display:none;">
										...
										<div class="col-sm-9">
											<input type="number" name="cn_choosesort" id="o" placeholder="排序" class="col-xs-10 col-sm-5" value="">
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="en_ftname" id="url" placeholder="中文产品名称" class="col-xs-10 col-sm-5" value="">
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea name="en_fttitle" rows="3" cols="8" style="width:400px; height:100px;"></textarea>
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea name="en_ftspec" id="en_ftspec" style="width:100%;height:400px;visibility:hidden;"><?php echo ($article['content']); ?></textarea>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="col-xs-10 col-sm-5"><?php echo UpImage("en_ftimg",88,31);?></div>
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">仅支持jpg、gif、png、bmp、jpeg，且小于1MB。</span>
											</span>
										</div>
									...
									<div class="form-group" style="display:none;">
										...
										<div class="col-sm-9">
											<input type="radio" name="en_choose" id=""  value="1">推荐&nbsp;&nbsp;&nbsp;
											<input type="radio" name="en_choose" id=""  value="2">不推荐
										</div>
									</div>
									...
									<div class="form-group" style="display:none;">
										...
										<div class="col-sm-9">
											<input type="number" name="en_choosesort" id="o" placeholder="排序" class="col-xs-10 col-sm-5" value="">
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">越小越靠前。</span>
											</span>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" name="ftsort" id="o" placeholder="排序" class="col-xs-10 col-sm-5" value="">
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">越小越靠前。</span>
											</span>
										</div>
