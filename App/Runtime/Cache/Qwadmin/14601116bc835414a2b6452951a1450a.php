							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="cn_fghz" id="title" placeholder="中文FELG频率" class="col-xs-10 col-sm-5" value="<?php echo ($link["cn_fghz"]); ?>">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea name="cn_fghztitle" rows="3" cols="46"><?php echo ($link['cn_fghztitle']); ?></textarea>
								   ...
								   <div class="space-4"></div>
									     <div class="form-group">
											...
											<div class="col-sm-9">
												<div class="col-xs-10 col-sm-5"><?php echo UpImage("cn_fghzimg",88,31,$link['cn_fghzimg']);?></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="en_fghz" id="title" placeholder="英文FELG频率" class="col-xs-10 col-sm-5" value="<?php echo ($link["en_fghz"]); ?>">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea name="en_fghztitle" rows="3" cols="46"><?php echo ($link['en_fghztitle']); ?></textarea>
								   ...
								   <div class="space-4"></div>
									     <div class="form-group">
											...
											<div class="col-sm-9">
												<div class="col-xs-10 col-sm-5"><?php echo UpImage("en_fghzimg",88,31,$link['en_fghzimg']);?></div>
												<span class="help-inline col-xs-12 col-sm-7">
													<span class="middle">仅支持jpg、png，且小于1MB。</span>
												</span>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" name="fghzsort" id="o" placeholder="排序" class="col-xs-10 col-sm-5" value="<?php echo ($link["fghzsort"]); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
