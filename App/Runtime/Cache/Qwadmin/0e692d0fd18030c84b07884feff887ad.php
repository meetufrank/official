							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 中文FEIG标题 </label>
										<div class="col-sm-9">
											<input type="text" name="cn_fghzname" id="title" placeholder="中文FEIG标题" class="col-xs-10 col-sm-5" value="<?php echo ($link['cn_fghzname']); ?>">
										</div>
									</div>
									...
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 英文FEIG标题 </label>
										<div class="col-sm-9">
											<input type="text" name="en_fghzname" id="title" placeholder="英文FEIG标题" class="col-xs-10 col-sm-5" value="<?php echo ($link['en_fghzname']); ?>">
										</div>
									</div>
									...
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 中文FELG是否开启 </label>
										<div class="col-sm-9">
											<input type="radio" name="cn_fghzshow" id=""  <?php if($link['cn_fghzshow'] == 1): ?>checked="checked" <?php else: endif; ?> value="1">开启&nbsp;&nbsp;&nbsp;
											<input type="radio" name="cn_fghzshow" id=""  <?php if($link['cn_fghzshow'] == 2): ?>checked="checked" <?php else: endif; ?> value="2">不开启
										</div>
									</div>
									
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 英文FELG是否开启 </label>
										<div class="col-sm-9">
											<input type="radio" name="en_fghzshow" id=""  <?php if($link['en_fghzshow'] == 1): ?>checked="checked" <?php else: endif; ?> value="1">开启&nbsp;&nbsp;&nbsp;
											<input type="radio" name="en_fghzshow" id=""  <?php if($link['en_fghzshow'] == 2): ?>checked="checked" <?php else: endif; ?> value="2">不开启
										</div>
									</div>
									...
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 中文RFLINKER标题 </label>
										<div class="col-sm-9">
											<input type="text" name="cn_rrhzname" id="title" placeholder="中文RFLINKER标题" class="col-xs-10 col-sm-5" value="<?php echo ($link['cn_rrhzname']); ?>">
										</div>
									</div>
									...
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 英文RFLINKER标题 </label>
										<div class="col-sm-9">
											<input type="text" name="en_rrhzname" id="title" placeholder="英文RFLINKER标题" class="col-xs-10 col-sm-5" value="<?php echo ($link['en_rrhzname']); ?>">
										</div>
									</div>
									...
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 中文RFLINKER是否开启 </label>
										<div class="col-sm-9">
											<input type="radio" name="cn_rrhzshow" id=""  <?php if($link['cn_rrhzshow'] == 1): ?>checked="checked" <?php else: endif; ?> value="1">开启&nbsp;&nbsp;&nbsp;
											<input type="radio" name="cn_rrhzshow" id=""  <?php if($link['cn_rrhzshow'] == 2): ?>checked="checked" <?php else: endif; ?> value="2">不开启
										</div>
									</div>
									
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 英文RFLINKER是否开启 </label>
										<div class="col-sm-9">
											<input type="radio" name="en_rrhzshow" id=""  <?php if($link['en_rrhzshow'] == 1): ?>checked="checked" <?php else: endif; ?> value="1">开启&nbsp;&nbsp;&nbsp;
											<input type="radio" name="en_rrhzshow" id=""  <?php if($link['en_rrhzshow'] == 2): ?>checked="checked" <?php else: endif; ?> value="2">不开启
										</div>
									</div>
									...
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 中文推荐标题 </label>
										<div class="col-sm-9">
											<input type="text" name="cn_tjhzname" id="title" placeholder="中文推荐标题" class="col-xs-10 col-sm-5" value="<?php echo ($link['cn_tjhzname']); ?>">
										</div>
									</div>
									...
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 英文推荐标题 </label>
										<div class="col-sm-9">
											<input type="text" name="en_tjhzname" id="title" placeholder="英文推荐标题" class="col-xs-10 col-sm-5" value="<?php echo ($link['en_tjhzname']); ?>">
										</div>
									</div>
									...
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 中文推荐是否开启 </label>
										<div class="col-sm-9">
											<input type="radio" name="cn_tjhzshow" id=""  <?php if($link['cn_tjhzshow'] == 1): ?>checked="checked" <?php else: endif; ?> value="1">开启&nbsp;&nbsp;&nbsp;
											<input type="radio" name="cn_tjhzshow" id=""  <?php if($link['cn_tjhzshow'] == 2): ?>checked="checked" <?php else: endif; ?> value="2">不开启
										</div>
									</div>
									
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 英文推荐是否开启 </label>
										<div class="col-sm-9">
											<input type="radio" name="en_tjhzshow" id=""  <?php if($link['en_tjhzshow'] == 1): ?>checked="checked" <?php else: endif; ?> value="1">开启&nbsp;&nbsp;&nbsp;
											<input type="radio" name="en_tjhzshow" id=""  <?php if($link['en_tjhzshow'] == 2): ?>checked="checked" <?php else: endif; ?> value="2">不开启
										</div>
									</div>
