...
<html lang="zh-CN">
	<head>
		...
		<meta charset="utf-8" />
		<title>控制台-<?php echo (C("title")); ?></title>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									...
									<div  style="display:none;" id="accordion" class="accordion-style1 panel-group col-sm-5">
									...
									<div  style="display:none;" id="Facebook-info" class="accordion-style1 panel-group col-sm-4">
												<div class="panel panel-default">
													<div class="panel-heading">
														<h4 class="panel-title">
													...
													<div class="panel-collapse collapse in" id="Facebook">
														<div class="panel-body">
															<form class="form-horizontal" id="form" method="post" action="<?php echo U('facebook/add',array('act'=>'update'));?>">
