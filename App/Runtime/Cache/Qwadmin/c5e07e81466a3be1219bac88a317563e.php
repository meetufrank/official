							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="title" id="title" placeholder="用户组名" class="col-xs-10 col-sm-5" value="<?php echo ($group["title"]); ?>">
									...
									<div class="form-group">
										...
										<div class="control-label no-padding-left col-sm-1">
											<label>
												<input name="status" id="status" <?php if($group['status'] == 1): ?>checked="checked"<?php endif; ?> class="ace ace-switch ace-switch-2" type="checkbox" />
												<span class="lbl"></span>
											</label>
										</div>
										<span class="help-inline col-xs-12 col-sm-7">
													...
													<div class="widget-box">
														<div class="widget-header">
															<h4 class="widget-title">
																<label>
																	<input name="rules[]" class="ace ace-checkbox-2 father" <?php if(in_array($v['id'],$group['rules'])){echo 'checked="checked"';};?> type="checkbox" value="<?php echo ($v['id']); ?>"/>
														...
														<?php if(!empty($v["children"])): ?><div class="widget-body">
															<div class="widget-main row">
																<?php if(is_array($v["children"])): $i = 0; $__LIST__ = $v["children"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><label class="col-xs-2" style="width:160px;" >
																	<input name="rules[]" class="ace ace-checkbox-2 children" <?php if(in_array($vv['id'],$group['rules'])){echo 'checked="checked"';};?> type="checkbox" value="<?php echo ($vv['id']); ?>"/>
																	...
																	<?php if(is_array($vv["children"])): $i = 0; $__LIST__ = $vv["children"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vvv): $mod = ($i % 2 );++$i;?><label class="col-xs-2" style="width:160px;" >
																		<input name="rules[]" class="ace ace-checkbox-2 children" <?php if(in_array($vvv['id'],$group['rules'])){echo 'checked="checked"';};?> type="checkbox" value="<?php echo ($vvv['id']); ?>"/>
