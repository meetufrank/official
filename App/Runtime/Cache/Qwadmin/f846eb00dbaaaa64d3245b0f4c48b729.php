				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									<form class="form-horizontal" id="form" method="post" action="<?php echo U('downedit');?>?id=<?php echo ($id); ?>" enctype="multipart/form-data">
									<!-- 产品id -->
                                   ...
                                   <div class="space-4"></div>
									 <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="file" name="photo[]"  placeholder="中文上传文件" class="col-xs-10 col-sm-5" value="<?php echo ($fgdown["cn_down"]); ?>">
										    <?php if($fgdown["cn_felgdownname"] != '' ): ?>已上传中文文件名称&nbsp;&nbsp;<input type="text" value="<?php echo ($fgdown["cn_felgdownname"]); ?>" readonly="true"/>
											<?php else: ?>
											   中文文件暂未上传<?php endif; ?>
								   ...
								   <div class="space-4"></div>
									 <div class="form-group">
										...
										<div class="col-sm-9">
											...
											<?php if($fgdown["en_felgdownname"] != '' ): ?>已上传英文文件名称&nbsp;&nbsp;<input type="text" value="<?php echo ($fgdown["en_felgdownname"]); ?>" readonly="true"/>
											<?php else: ?>
											   英文文件暂未上传<?php endif; ?>
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle"></span>
