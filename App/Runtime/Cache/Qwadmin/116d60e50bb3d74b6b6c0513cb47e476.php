				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo U('Industry/index');?>">行业类别</a>
							</li>
					...
					<div class="page-content">
						...
						<a class="btn btn-info" href="<?php echo U('industryimgsadd');?>?id=<?php echo ($id); ?>" value="">新增行业轮播图</a>
									               
								
								<div class="space-4"></div>

								<form id="form" method="post" action="<?php echo U('deliy');?>">
									...
									<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td class="center">	  
											  <?php if($val['cn_iyimgs'] != ''): ?><img src="<?php echo ($val['cn_iyimgs']); ?>" style="width:100px; height:50px;"><?php else: ?>暂无图片<?php endif; ?>
											</td>
								             <td class="center">	  
											  <?php if($val['en_iyimgs'] != ''): ?><img src="<?php echo ($val['en_iyimgs']); ?>" style="width:100px; height:50px;"><?php else: ?>暂无图片<?php endif; ?>
											</td>
											<td class="center"><?php echo ($val['iyimgssort']); ?></td>
											<td class="center">
											   <a href="<?php echo U('industryimgsedit');?>?id=<?php echo ($val['id']); ?>"><i class="ace-icon fa fa-pencil bigger-100"></i>修改</a>&nbsp&nbsp;
											   <a href="javascript:;" val="<?php echo U('deliy');?>?ids=<?php echo ($val['id']); ?>" class="dellink"><i class="ace-icon fa fa-trash-o bigger-100 red"></i>删除</a></td>
