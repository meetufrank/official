							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="dowusername" id="title" placeholder="用户名" class="col-xs-10 col-sm-5" value="<?php echo ($link['dowusername']); ?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="url" name="dowuserpwd" id="url" placeholder="用户密码" class="col-xs-10 col-sm-5" value="<?php echo ($link['dowuserpwd']); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="space-4"></div>
								    <div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-2"> 账号备注 </label>
										<div class="col-sm-9">
											<input type="url" name="dowremark" id="url" placeholder="账号备注" class="col-xs-10 col-sm-5" value="<?php echo ($link['dowremark']); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">账号备注。</span>
											</span>
										</div>
									</div>
