				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo U('Rflinkerproduct/index');?>">Frlinker系列产品</a>
							</li>
							<li>
								Frlinker产品
							</li>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-inline" action="<?php echo U('index');?>" method="get">
									<!-- <label class="inline">中文产品名称</label> -->
                                    <select name="typeptname">
									       <option  <?php if($type == 1): ?>selected="selected"<?php endif; ?> value="1">中文产品名称</option>
									       <option  <?php if($type == 2): ?>selected="selected"<?php endif; ?> value="2">英文产品名称</option>
									</select>
									<input type="text" name="kw" value="<?php echo I('kw');?>" placeholder="产品名称">&nbsp;&nbsp;
                                    <button type="submit" class="btn btn-purple btn-sm">
												<span class="ace-icon fa fa-search icon-on-right bigger-110"></span>
												查询
											</button>
											&nbsp;&nbsp;&nbsp;<a class="btn btn-info" href="<?php echo U('add');?>" value="">新增RFLINKER产品</a>
									</div>
								...
								<form id="form" method="post" action="<?php echo U('del');?>">
									...
									<thead>
										<tr>
											...
											<th class="col-xs-1 center">英文产品名称</th>
									...
									<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
											...
											<td class="center"><?php echo ($val['cn_rrname']); ?></td>
											<td class="center"><?php echo ($val['en_rrname']); ?></td>
											<td class="center"><?php if($val['rflinkercnhzname'] != '0'): echo ($val['rflinkercnhzname']); ?> <?php else: ?>暂无中文频率<?php endif; ?></td>
											<td class="center"><?php if($val['rflinkerenhzname'] != '0'): echo ($val['rflinkerenhzname']); ?> <?php else: ?>暂无英文频率<?php endif; ?></td>
											<td class="center"><?php if($val['rflinkercntypename'] != '0'): echo ($val['rflinkercntypename']); ?> <?php else: ?>暂无中文类型<?php endif; ?></td>
											<td class="center"><?php if($val['rflinkerentypename'] != '0'): echo ($val['rflinkerentypename']); ?> <?php else: ?>暂无英文类型<?php endif; ?></td>
											<td class="center"><?php echo ($val['rrsort']); ?></td>
											<td class="center"><a href="<?php echo U('edit');?>?id=<?php echo ($val['id']); ?>"><i class="ace-icon fa fa-pencil bigger-100"></i>修改</a>
											<a href="<?php echo U('rrmatching');?>?id=<?php echo ($val['id']); ?>"><i class="ace-icon fa fa-arrows-h bigger-100"></i>匹配</a>
											<a href="<?php echo U('rrfelgDown');?>?id=<?php echo ($val['id']); ?>"><i class="ace-icon fa fa-arrow-down bigger-100"></i>下载</a>
											<!-- <a href="<?php echo U('rrfelgmmdown');?>?id=<?php echo ($val['id']); ?>"><i class="ace-icon fa fa-download bigger-100"></i>密码下载</a> -->
											<a href="javascript:;" val="<?php echo U('del');?>?ids=<?php echo ($val['id']); ?>" class="dellink"><i class="ace-icon fa fa-trash-o bigger-100 red"></i>删除</a></td>
