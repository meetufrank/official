								...
								<div class="row">
									<form id="form" method="post" action="<?php echo U('del');?>">
										...
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
												...
												<td class="center"><a href="<?php echo U('edit');?>?uid=<?php echo ($val['uid']); ?>">修改</a>&nbsp;<?php if($val['uid'] != 1): ?><a class="del" href="javascript:;" val="<?php echo U('del');?>?uids=<?php echo ($val['uid']); ?>" title="删除">删除</a><?php endif; ?></td>
