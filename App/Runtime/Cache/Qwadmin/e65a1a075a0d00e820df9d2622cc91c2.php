								...
								<form id="form" method="post" action="<?php echo U('del');?>">
									...
									<thead>
										<tr>
											...
											<th class="col-xs-2 center">FELG类型中文</th>
											<th class="col-xs-2 center">FELG类型英文</th>
									...
									<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
											...
											<td class="center"><?php echo ($val['cn_fgtypename']); ?></td>
											<td class="center"><?php echo ($val['en_fgtypename']); ?></td>
											<td class="center"><?php echo ($val['fgtypesort']); ?></td>
