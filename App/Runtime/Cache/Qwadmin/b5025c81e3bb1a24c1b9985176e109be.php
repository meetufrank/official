							...
							<div class="col-xs-12">	
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-2"> 提问类型</label>
										<div class="col-sm-9">
											<input type="radio" name="en_fwshowphone" disabled="disabled"  <?php if($link['mtype'] == 1): ?>checked="checked" <?php else: endif; ?>  value="1">销售类问题&nbsp;&nbsp;
											<input type="radio" name="en_fwshowphone" disabled="disabled" <?php if($link['mtype'] == 2): ?>checked="checked" <?php else: endif; ?>value="2">技术类问题
											<span>
									...
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-2"> 姓名 </label>
										<div class="col-sm-9">
											<input type="url" disabled="disabled" name="cn_fwlink" id="url" placeholder="姓名" class="col-xs-10 col-sm-5" value="<?php echo ($link['mname']); ?>">
									...
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-2"> 手机号 </label>
										<div class="col-sm-9">
											<input type="url" disabled="disabled" name="cn_fwlink" id="url" placeholder="手机号" class="col-xs-10 col-sm-5" value="<?php echo ($link['mtel']); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-2"> 邮箱 </label>
										<div class="col-sm-9">
											<input type="url" disabled="disabled" name="cn_fwlink" id="url" placeholder="邮箱" class="col-xs-10 col-sm-5" value="<?php echo ($link['memail']); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-2"> 留言内容 </label>
										<div class="col-sm-9">
											<!-- <input type="url" disabled="disabled" name="cn_fwlink" id="url" placeholder="留言内容" class="col-xs-10 col-sm-5" value="<?php echo ($link['mcontent']); ?>"> -->
											<textarea disabled="disabled" rows="10" cols="60"><?php echo ($link['mcontent']); ?></textarea>
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-2"> 时间 </label>
										<div class="col-sm-9">
											<input type="url" disabled="disabled" name="cn_fwlink" id="url" placeholder="时间" class="col-xs-10 col-sm-5" value="<?php echo ($link['mtime']); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="col-md-offset-2 col-md-9">
										<button class="btn btn-info submit" type="button">
											...
											<a class="btn btn-info" href="<?php echo U('index');?>" value="">返回联系我们列表</a>
										</button>
