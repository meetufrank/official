					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<div class="cf">
									<a class="btn btn-info" href="<?php echo U('felgMmDownadd');?>?id=<?php echo ($id); ?>" value="">新增密码产品下载</a>
								...
								<form id="form" method="post" action="<?php echo U('del');?>">
									...
									<thead>
										<tr>
											...
											<th class="col-xs-2 center">中文产品</th>
									...
									<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
											...
											<td class="center"><?php echo ($val['cn_mmdownname']); ?></td>
											<td class="center"><?php echo ($val['en_mmdownname']); ?></td>
											<td class="center"><?php echo ($val['mmdownsort']); ?></td>
											<td class="center">
											<a href="<?php echo U('felgmmdownedit');?>?id=<?php echo ($val['id']); ?>"><i class="ace-icon fa fa-pencil bigger-100"></i>修改</a>

											&nbsp&nbsp;
											<a href="javascript:;" val="<?php echo U('felgptmmdndel');?>?ids=<?php echo ($val['id']); ?>" class="dellink">
