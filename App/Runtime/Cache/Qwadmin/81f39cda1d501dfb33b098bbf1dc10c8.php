					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<div class="cf">
									<a class="btn btn-info" href="<?php echo U('add');?>" value="">新增FELG频率</a>
								</div>
								...
								<form id="form" method="post" action="<?php echo U('del');?>">
									...
									<thead>
										<tr>
											...
											<th class="col-xs-2 center">中文FELG频率</th>
											<th class="col-xs-2 center">英文FELG频率</th>
									...
									<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
											...
											<td class="center"><?php echo ($val['cn_fghz']); ?></td>
											<td class="center"><?php echo ($val['en_fghz']); ?></td>
											<td class="center"><?php echo ($val['fghzsort']); ?></td>
