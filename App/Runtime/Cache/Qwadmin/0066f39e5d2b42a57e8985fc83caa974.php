								...
								<form id="form" method="post" action="<?php echo U('del');?>">
									...
									<thead>
										<tr>
											...
											<th class="col-xs-2 center">提问类型</th>
											<th class="col-xs-2 center">姓名</th>
											<th class="col-xs-2 center">手机号</th>
                                            <th class="col-xs-2 center">邮箱</th>
											<th class="col-xs-2 center">时间</th>
									...
									<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td class="center">
											    <?php if($val['mtype'] == 1): ?>销售类问题<?php elseif($val['mtype'] == 2): ?>技术类问题<?php endif; ?>
											</td>
											<td class="center"><?php echo ($val['mname']); ?></td>
											<td class="center"><?php echo ($val['mtel']); ?></td>
										    <td class="center"><?php echo ($val['memail']); ?></td>
											<td class="center"><?php echo ($val['mtime']); ?></td>
											<td class="center"><a href="<?php echo U('edit');?>?id=<?php echo ($val['id']); ?>"><i class="ace-icon fa fa-pencil bigger-100"></i>查看</a>&nbsp&nbsp;<a href="javascript:;" val="<?php echo U('del');?>?ids=<?php echo ($val['id']); ?>" class="dellink"><i class="ace-icon fa fa-trash-o bigger-100 red"></i>删除</a></td>
