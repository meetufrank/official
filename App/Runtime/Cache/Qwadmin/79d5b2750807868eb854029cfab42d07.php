				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									<form class="form-horizontal" id="form" method="post" action="<?php echo U('update');?>?id=<?php echo ($link["id"]); ?>" enctype="multipart/form-data">

									<div class="space-4"></div>
								    <div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-2"> 中文下载类型</label>
										<div class="col-sm-9">
<!-- 											<input type="radio" name="cn_sttype" <?php if($link["cn_sttype"] == 1): ?>checked="checked"<?php endif; ?>  value="1">CDK&nbsp;&nbsp;
<input type="radio" name="cn_sttype" <?php if($link["cn_sttype"] == 2): ?>checked="checked"<?php endif; ?>  value="2">DEMO&nbsp;&nbsp; -->
											<input type="radio" name="cn_sttype" <?php if($link["cn_sttype"] == 3): ?>checked="checked"<?php endif; ?>  value="3">公共
											<span>
									...
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 中文下载标题 </label>
										<div class="col-sm-9">
											<input type="text" name="cn_stname" id="title" placeholder="中文下载标题" class="col-xs-10 col-sm-5" value="<?php echo ($link["cn_stname"]); ?>">
									...
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 中文下载简介 </label>
										<div class="col-sm-9">
											<textarea name="cn_sttitle"  rows="3" cols="60"><?php echo ($link["cn_sttitle"]); ?></textarea>
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<?php if($link["cn_downname"] != '' ): ?>已上传中文文件名称&nbsp;&nbsp;<input type="text" value="<?php echo ($link["cn_downname"]); ?>" readonly="true"/>
											<?php else: ?>
											   中文文件暂未上传<?php endif; ?>
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle"></span>
									...
									<div class="space-4"></div>
								    <div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-2"> 英文下载类型 </label>
										<div class="col-sm-9">
											<!-- <input type="radio" name="en_sttype" <?php if($link["en_sttype"] == 1): ?>checked="checked"<?php endif; ?>  value="1">CDK&nbsp;&nbsp;
											<input type="radio" name="en_sttype" <?php if($link["en_sttype"] == 2): ?>checked="checked"<?php endif; ?> value="2">DEMO&nbsp;&nbsp; -->
											<input type="radio" name="en_sttype" <?php if($link["en_sttype"] == 3): ?>checked="checked"<?php endif; ?> value="3">公共
											<span>
												<span class="middle"></span>
											</span>
										</div>
									...
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 英文下载标题 </label>
										<div class="col-sm-9">
											<input type="text" name="en_stname" id="title" placeholder="标题" class="col-xs-10 col-sm-5" value="<?php echo ($link["en_stname"]); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle"></span>
											</span>
										</div>
									...
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-2"> 英文下载简介 </label>
										<div class="col-sm-9">
											<textarea name="en_sttitle"  rows="3" cols="60"><?php echo ($link["en_sttitle"]); ?></textarea>
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										    ...
										    <?php if($link["en_downname"] != '' ): ?>已上传英文文件名称&nbsp;&nbsp;<input type="text" value="<?php echo ($link["en_downname"]); ?>" readonly="true"/>
											<?php else: ?>
											   英文文件暂未上传<?php endif; ?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" name="stsort" id="o" placeholder="排序" class="col-xs-10 col-sm-5" value="<?php echo ($link["stsort"]); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
