...
<section class="code-section">
    <div class="code-container" style="padding-top: 60px;">
          <div class="section-title code-section-title" id="code-section-title">
            <form>
			<p><?php echo (L("code_downfrom_title")); ?></p>
            <p><input id="dowusername" type="text" class="code-form-input" placeholder="<?php echo (L("supportservices_dowusername")); ?>"></p>
            <p><input id="dowuserpwd" type="password" class="code-form-input" placeholder="<?php echo (L("supportservices_dowuserpwd")); ?>"></p>
            <p><button id="btn" type="button" class="code-submit" onclick="codeinput()">Submit</button></p>
            </form>
          </div>
    </div>
</section>
...
<script>
 ...
 function codeinput(){
    ...
    //用户名
    $dowusername = $("#dowusername").val();	
	
	$nameerror = "<?php echo (L("supportservices_dowusernameerror")); ?>";
	if($dowusername == ''){
	       alert($nameerror);
		   return;
	}
	var name = $dowusername;

	$codelink = "<?php echo U('Supportservices/Index');?>?name="+name;
	                 
	                              
	             
	//密码
    $dowuserpwd = $("#dowuserpwd").val();
    $pwderror = "<?php echo (L("supportservices_dowuserpwderror")); ?>";	
	if($dowuserpwd == ''){
	       alert($pwderror);
		   return;
	}
