...
<head>
  ...
  <!-- Swiper styles -->
    <style>
     ...
     .swiper-slide-01{
        background-image:url(/Public/qiantai/images/about-us.jpg);
     }
...
<section id="portfolio" class="product-list-section">
    <div class="productlist-section-title">
        <a href="<?php echo U('Supportservices/Index');?>" class="product-a"><span class="product-header-class cdk-class-one" style="    background-color: rgb(238,238,238);color: black">FEIG</span></a>
        <a href="#" class="product-a"><span class="product-header-class cdk-class-two" style="background-color: #02AAF1;color: black">Rflinker</span></a>
    ...
    <div class="nav-section-title nac-feig-title">
      <p class="product-p-border">Frequency</p>
        <ul id="filters" class="nav">
            <?php if(is_array($Hz)): $i = 0; $__LIST__ = $Hz;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><!-- 频率取第一个 -->
                <li onclick="docdwon('<?php echo ($vo["rrhzname"]); ?>')" class="filter hzclass <?php if($i == 1): ?>active<?php endif; ?>" id="filter<?php echo ($vo['rrhzname']); ?>" data-filter="lf"><?php echo ($vo["rrhzname"]); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
    </div>
    ...
    <div class="nav-section-title nac-feig-title">
      ...
      <ul id="filter_s" class="nav">
         ...
         <?php if(is_array($Type)): $i = 0; $__LIST__ = $Type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="filter typeclass" id="type<?php echo ($vo['rrtypename']); ?>" onclick="docdwon('<?php echo ($YiHzName); ?>','<?php echo ($vo['rrtypename']); ?>')" data-filter="<?php echo ($vo["rrtypename"]); ?>"><?php echo ($vo["rrtypename"]); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>
      </ul>
    </div>
    ...
    <div class="nav-section-title nac-feig-title">
      ...
      <ul id="filter_ss" class="nav">
          ...
          <?php if(is_array($PtName)): $i = 0; $__LIST__ = $PtName;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="filter ptclass" data-filter="<?php echo ($vo["ftname"]); ?>" onclick="docdwon('<?php echo ($YiHzName); ?>','6','<?php echo ($vo['rrname']); ?>')"><?php echo ($vo["rrname"]); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>
      </ul>
    </div>
    ...
    <ul id="works-list" class="nav">
        <?php if(is_array($PtDoc)): $i = 0; $__LIST__ = $PtDoc;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a><li class="mix graphic mix_all acessories" style="display: inline-block; opacity: 1;"><div class="team animated fadeInUp visible" data-animation="fadeInUp" data-animation-delay="0"><div class="team-info-download"><h4><?php echo ($vo["docname"]); ?></h4>
             <a target="_blank"  href="/Public/Uploads/<?php echo ($vo["docurl"]); ?>"><button type="button"  class="sup-downloadbutton">Download<i class="fa fa-download"></i></button></a>
...
<script>
        ...
        function docdwon(hzname,typename,ptname){
            ...
            $.ajax({
                      type:"post",
                      url:"/index.php/Home/Supportservicesdemo/docdwons",
                      dataType:"json",
                      ...
                      success:function(data){
                            ...
                            if(data.hz == 1){
                                ...
                                $.each(data.ptdoc,function(i){
                                  htmlptdoc += '<a></a><li class="mix graphic mix_all acessories" style="display: inline-block; opacity: 1;"><a></a><div class="team animated fadeInUp visible" data-animation="fadeInUp" data-animation-delay="0"><a></a><div class="team-info-download"><a><h4>'+data.ptdoc[i].docname+'</h4></a><a target="_blank" href="/Public/Uploads/'+data.ptdoc[i].docurl+'"><button type="button" class="sup-downloadbutton">Download<i class="fa fa-download"></i></button></a></div></div></li>';
  ...
  //类型样式
        ...
        function jiazaiyi(hzname){
                 ...
                 $p = pageyi;
                  ...
                  $.ajax({
                  url:"/index.php/Home/Supportservicesdemo/jiazaiyis",
                  type:'post',
                  dataType:'json',
                  ...
                  success:function(data){
                                  ...
                                  $.each(data.ptdoc,function(i){
                                                       ...
                                                       html += '<a></a><li class="mix graphic mix_all acessories" style="display: inline-block; opacity: 1;"><a></a><div class="team animated fadeInUp visible" data-animation="fadeInUp" data-animation-delay="0"><a></a><div class="team-info-download"><a><h4>'+data.ptdoc[i].docname+'</h4></a><a target="_blank" href="/Public/Uploads/'+data.ptdoc[i].docurl+'"><button type="button" class="sup-downloadbutton">Download<i class="fa fa-download"></i></button></a></div></div></li>';
                                                         count = data.ptdoc[i].count;
        ...
        function jiazaitype(hzname,typename){
                 ...
                 $p = pagetype;
                  ...
                  $.ajax({
                  url:"/index.php/Home/Supportservicesdemo/jiazaitype",
                  type:'post',
                  dataType:'json',
